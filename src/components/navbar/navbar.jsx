    ...
    return(
        <div className="navbar">
            ...
            <div className={`navbar__items ${menuOpen ? 'active': '' }`}>
                <ul>
                    <li onClick={() => setMenuOpen(false)}><NavLink exact="true" className={({ isActive }) => isActive ? 'active' : 'hover' } to="/home"><span className="items__numbers">00</span> HOME</NavLink></li>
